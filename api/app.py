...
DATA_PATH = "./data/clientes_segmentados.csv"
...
# Endpoint de Datos para Visualización (/dashboard-data) (#10)
@app.get("/dashboard-data")
def get_dashboard_data():
    logger.info("Petición recibida en /dashboard-data")
    if clientes_df is None:
        raise HTTPException(status_code=404, detail="Datos analíticos no disponibles.")
    return {
        "total_usuarios": len(clientes_df),
